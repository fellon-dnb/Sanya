...
/**
 * EncryptorSelfTest — автономный тест без JUnit.
 * Проверяет корректность шифрования и расшифровки AES-GCM с использованием X25519.
 */
public final class EncryptorSelfTest {
    ...
    public static void main(String[] args) {
        ...
        // 8. Выводим сессионный ключ в hex
